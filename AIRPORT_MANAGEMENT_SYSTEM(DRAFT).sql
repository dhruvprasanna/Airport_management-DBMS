...
INSERT INTO AIRPORT (AP_NAME, STATE, COUNTRY, CNAME) VALUES('Kempegowda International Airport','Karnataka','India','Bangalore');
...
INSERT INTO EMPLOYEE1(SSN, FNAME, LNAME, ADDRESS, PHONE, AGE, SEX, JOBTYPE,AP_NAME)
VALUES(123456789,'LINDA','GOODMAN','731 Fondren, Houston, TX',4356789345, 35, 'F','ADMINISTRATIVE SUPPORT','Kempegowda International Airport');

INSERT INTO EMPLOYEE1(SSN, FNAME, LNAME, ADDRESS, PHONE, AGE, SEX, JOBTYPE,AP_NAME)
VALUES(333445555,'JOHNY','PAUL','638 Voss, Houston, TX',9834561995, 40, 'M','ADMINISTRATIVE SUPPORT','Kempegowda International Airport');

INSERT INTO EMPLOYEE1(SSN, FNAME, LNAME, ADDRESS, PHONE, AGE, SEX, JOBTYPE,AP_NAME)
VALUES(999887777,'JAMES','BOND','3321 Castle, Spring, TX',9834666995, 50, 'M','ENGINEER','Kempegowda International Airport');


INSERT INTO EMPLOYEE1(SSN, FNAME, LNAME, ADDRESS, PHONE, AGE, SEX, JOBTYPE,AP_NAME)
VALUES(987654321,'SHERLOCK','HOLMES','123 TOP HILL, SAN Francisco,CA',8089654321, 47, 'M','TRAFFIC MONITOR','Kempegowda International Airport');

INSERT INTO EMPLOYEE1(SSN, FNAME, LNAME, ADDRESS, PHONE, AGE, SEX, JOBTYPE,AP_NAME)
VALUES(666884444,'SHELDON','COOPER','345 CHERRY PARK, HESSE,GERMANY',1254678903, 55, 'M','TRAFFIC MONITOR','Kempegowda International Airport');


INSERT INTO EMPLOYEE1(SSN, FNAME, LNAME, ADDRESS, PHONE, AGE, SEX, JOBTYPE,AP_NAME)
VALUES(453453453,'RAJ','SHARMA','345 FLOYDS, MUMBAI,INDIA',4326789031, 35, 'M','AIRPORT AUTHORITY','Kempegowda International Airport');


INSERT INTO EMPLOYEE1(SSN, FNAME, LNAME, ADDRESS, PHONE, AGE, SEX, JOBTYPE,AP_NAME)
VALUES(987987987,'NIKITA','PAUL','110 SYNERGY PARK, DALLAS,TX',5678904325, 33, 'F','ENGINEER','Kempegowda International Airport');


INSERT INTO EMPLOYEE1(SSN, FNAME, LNAME, ADDRESS, PHONE, AGE, SEX, JOBTYPE,AP_NAME)
VALUES(888665555,'SHUBHAM','GUPTA','567 CHANDANI CHOWK, DELHI, INDIA',8566778890, 39, 'M','ADMINISTRATIVE SUPPORT','Kempegowda International Airport');

INSERT INTO EMPLOYEE1(SSN, FNAME, LNAME, ADDRESS, PHONE, AGE, SEX, JOBTYPE,AP_NAME)
VALUES(125478909,'PRATIK','GOMES','334 VITRUVIAN PARK, ALBANY, NY',4444678903, 56, 'M','TRAFFIC MONITOR','Kempegowda International Airport');

INSERT INTO EMPLOYEE1(SSN, FNAME, LNAME, ADDRESS, PHONE, AGE, SEX, JOBTYPE,AP_NAME)
VALUES(324567897,'ADIT','DESAI','987 SOMNATH, CHANDIGARH, INDIA',2244658909, 36, 'M','TRAFFIC MONITOR','Kempegowda International Airport');
